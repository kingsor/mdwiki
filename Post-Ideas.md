...
* Sviluppatore Android via [Indigeni Digitali - Gruppo su Facebook](https://www.facebook.com/groups/indigeni/)
  ...
  CheckBonus sta cercando uno sviluppatore Android per la sua app. Si tratta dello sviluppo e aggiornamento frequente di un’applicazione con funzioni di geolocalizzazione, bluetooth beacons, push notifications, integrazione con back-end e social networks.  
  I requisiti sono:
...
* [is it ok to create ORMLite database helper in Application class?](http://stackoverflow.com/questions/8208992/is-it-ok-to-create-ormlite-database-helper-in-application-class)
* [android-orm-benchmar](https://github.com/littleinc/android-orm-benchmark) - Android application for benchmarking ORMLite and GreenDao against each other
...
* [Building Your First App with MongoDB](http://www.mongodb.com/presentations/building-your-first-app-mongodb)
* [MongoDB Use Cases](http://www.mongodb.com/use-cases)
...
* [MongoLab](https://mongolab.com/) - Power your app with the fastest-growing cloud database service in the world.

### Posts
* [Transitioning from Relational Databases to MongoDB - Data Models](http://blog.mongodb.org/post/72874267152/transitioning-from-relational-databases-to-mongodb)
...
* [Tracking Twitter Followers with MongoDB](http://blog.mongodb.org/post/61499097398/tracking-twitter-followers-with-mongodb)
    * [Scanner.java](https://github.com/drmirror/followt/blob/master/src/main/java/net/followt/Scanner.java)
    * [Requesting OAuth request token from Twitter API with RestSharp returns 404](http://stackoverflow.com/questions/12104603/requesting-oauth-request-token-from-twitter-api-with-restsharp-returns-404)
    * [Twitter Libraries](https://dev.twitter.com/docs/twitter-libraries)
        * [LINQ to Twitter](http://linqtotwitter.codeplex.com/)
* Aggregation Options on Big Data Sets
    * [Basic Analysis using a Flights Data Set](http://blog.mongodb.org/post/58919137318/aggregation-options-on-big-data-sets-part-1-basic)
    * [PageRank on Flights Dataset](http://blog.mongodb.org/post/60179655766/pagerank-on-flights-dataset)
    * [Twitter Memes Dataset Overview with PageRank](http://blog.mongodb.org/post/60751788450/twitter-memes-dataset-overview-with-pagerank)
* [Schema Design for Social Inboxes in MongoDB](http://blog.mongodb.org/post/65612078649/schema-design-for-social-inboxes-in-mongodb)
* [The Top 5 Metrics to Watch in MongoDB](http://blog.mongodb.org/post/62152249344/the-top-5-metrics-to-watch-in-mongodb)

I'd like to play with mongodb and REST api using Nancy framework.
...
* [Building a feed reader with AngularJS](http://davidandsuzi.com/building-a-feed-reader-with-angularjs/).
    * [Working sample](http://dchang.me/feed-reader/v1/)
    * [Finished Gist](https://gist.github.com/davidchang/4441416)
